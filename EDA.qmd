...
ggplot(diabetes, aes(x = PhysActivity, fill = response)) +
  ...
  labs(x = "Physical Activity Level", y = "Proportion", fill = "Diabetes Status", 
       main = "Physical Activity as a Predictor of Diabetes Status")

table(diabetes$PhysActivity, diabetes$response)

chisq.test(diabetes$PhysActivity, diabetes$response)

#fruit consumption and diabetes status
table(diabetes$Fruits, diabetes$response)

ggplot(diabetes, aes(x = Fruits, fill = response)) +
  geom_bar(position = "fill") +
  labs(x = "Fruit Consumption", y = "Proportion", fill = "Diabetes Status",
       main = "Fruit Consumption as a Predictor of Diabetes Status")

chisq.test(diabetes$Fruits, diabetes$response)

#BMI and diabetes status 
boxplot(BMI ~ response, data = diabetes, ylab = "Diabetes Status", main = "BMI Value by Diabetes Status")
