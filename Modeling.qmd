...
treephys_mod <- decision_tree(tree_depth = tune(),
                              min_n = tune(),
                              cost_complexity = tune()) |>
  set_engine("rpart") |>
  set_mode("classification")
treebmi_mod <- decision_tree(tree_depth = tune(),
                              min_n = tune(),
                              cost_complexity = tune()) |>
  set_engine("rpart") |>
  set_mode("classification")
treefruits_mod <- decision_tree(tree_depth = tune(),
                              min_n = tune(),
                              cost_complexity = tune()) |>
  set_engine("rpart") |>
  set_mode("classification")
...
treephys_wfl <- workflow() |>
  ...
  add_model(treephys_mod)
treebmi_wfl <- workflow() |>
  add_recipe(tree_bmi) |>
  add_model(treebmi_mod)
treefruits_wfl <- workflow() |>
  add_recipe(tree_fruits) |>
  add_model(treefruits_mod)
